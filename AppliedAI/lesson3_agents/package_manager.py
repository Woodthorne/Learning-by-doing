'''Original code from: https://github.com/sebastianmentor/PVSPYH23_Lektion3/blob/main/package_manager.py'''
...
class Environment:
    ...
    def perform_action(self, action):
        ...
        # Batteriet förbrukas
        if random.random() < 0.2:  # 20% chans att batteriet går från "high" till "low"
            self.robot_battery = "low"
